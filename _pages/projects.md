...
<div class="p-2">
    {% include figure.liquid loading="eager" path="assets/img/20250224_figure1_v1.png" %}
</div>
...
We understand <b>tissue development</b> as the <b>sum of all gene regulatory decisions</b> in the differentiating, proliferating, migrating and apoptosis inducing cells over time. In this framework, genetic variants cause disease by altering gene regulatory decisions (deterministic) or the possibility for such decisions (probabilistic) leading to changes in a tissue’s overall constitution such as cell composition & architecture, physiology & metabolism. To relate such manifestations of tissue dysregulation, i.e., experimental phenotypes or – more importantly – clinical symptoms to their actual cause, it is thus absolutely essential to understand the <b>nature of the disruption elicited by the variant</b>, including:
<br>
1.	The <b>disrupted cell type(s)</b> or cell state(s).
2.	The affected <b>developmental time point</b> along the tissue’s life trajectory.
3.	The <b>spatial distribution</b> of compromised cells in the tissue.
4.	The <b>gene regulatory element(s)</b> (i.e., enhancer(s) or promoter(s)) affected by the genetic variant and the strength with which this element’s activity is deregulated.
